...
module.exports = {
     ...
     */
    botname: process.env.BotName || "sithuwa-bot",
    ...
    ownernumber: process.env.Owner_Number || "0752902163",
    ...
    mongoUrl: process.env.MongoDB || "mongodb+srv://nilaweeraoshadha:i2cQACRemSueI9YE@cluster0.tmn7y.mongodb.net/",
